...
INSERT INTO account (id, name, email, active, hash)
VALUES ('2dae97cc-b0a3-4123-90ee-359e0528d371', 'Martin Perkins', 'mperkins1@wikipedia.org', TRUE, '$s0$e0801$ZHp8J5exL2SRKQ25Yux6EQ==$nYbsBiSo0+ihGvtrbXT60VgS+s1Oz6xdxSxNt7EgdH4=');
INSERT INTO account (id, name, email, active, hash)
VALUES ('41edb0b8-1f1a-4d9f-993d-f151c2b2ae4b', 'Raymond Woods', 'rwoods2@sitemeter.com', TRUE, '$s0$e0801$hqOter8wmgkA4pEtfd0iJA==$oOBlfhfRckbsSnlmYcXJSteJOMrlcf3YhD5oHSiV8Ks=');
INSERT INTO account (id, name, email, active, hash)
VALUES ('8574966d-fb6a-4bdf-bd59-2de3c1edcc19', 'Sean Hernandez', 'shernandez3@yellowbook.com', FALSE, '$s0$e0801$qzqKmkNfg+3ItOzb1F+6Mg==$RmFJUh7+KVo1yVsUkqPg96FUDJNQB16NQGWme9E3RB4=');
INSERT INTO account (id, name, email, active, hash)
VALUES ('e208462f-411f-4222-b957-0bddabe0fb99', 'Joan Rogers', 'jrogers4@shinystat.com', TRUE, '$s0$e0801$0mhCj97s1gG8FqbDtTSNqA==$YyXz8FOMQaomX2lBkAu2dsloixR2/t5IJGtMG6+6TAg=');
INSERT INTO account (id, name, email, active, hash)
VALUES ('11cbd1da-5358-4789-95e5-891fe72c34e6', 'Daniel Austin', 'daustin5@howstuffworks.com', FALSE, '$s0$e0801$AktkNjS7to7yTtp18ekKkg==$+sx5fw7G0pwZYpH2GdhXIZSda2mdSRbZ0ttPRgiMXPM=');
INSERT INTO account (id, name, email, active, hash)
VALUES ('b793c950-55b3-404d-9018-50e3f2c5f37c', 'Donald Montgomery', 'dmontgomery6@newyorker.com', TRUE, '$s0$e0801$vW6f0ZQT+4t3dNRxkh2bMg==$D0QOuCMbW4zDQqLutqgORnNvg+PtaNf267cQB8hNbe8=');
INSERT INTO account (id, name, email, active, hash)
VALUES ('371c7b83-bdfb-4845-814f-98bc6fdd2445', 'Eric Black', 'eblack7@cisco.com', TRUE, '$s0$e0801$i/rxogkVjjoaCWfu1VU3fg==$wtldNMnnQ8GGsBuA7GvET3WtXs4NCitE6kfg5BVfCjQ=');
INSERT INTO account (id, name, email, active, hash)
VALUES ('1b2bb37b-5666-4e4b-9d95-83ee41520423', 'Shirley Sanchez', 'ssanchez8@vinaora.com', FALSE, '$s0$e0801$5Jw8uceQqEXAPlZuPa1VFA==$N8iGauTvLedMwbFIVAZ0shm5JdBMMqjAHQQgCosoALA=');
