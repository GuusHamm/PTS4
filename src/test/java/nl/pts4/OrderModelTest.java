...
public class OrderModelTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        orderModel = new OrderModel(orderID, orderDate, 1, orderLines);
    }
    ...
    public void testGetAccount() throws Exception
    {
        ...
        Assert.assertTrue("OrderModel - Accounts ID do not match!", (orderModel.getAccount().getId()) == account.getId());
    }
    ...
    public void testSetOrderLines() throws Exception
    {
        ...
        orderLines2.add(new OrderLineModel(1,1));
